...
TEST(PerftTest, perftStartingPosition){
    ...
    int actualNodes =20+400+8902+197281+4865609+119060324;
    int actualCapture = 34+1576+82719+2812008;
    int actualEnPassant = 258+5248;

    EXPECT_EQ(actualNodes ,results.nodes);
    EXPECT_EQ(actualCapture, results.captures);
    EXPECT_EQ(actualEnPassant, results.enPassant);
