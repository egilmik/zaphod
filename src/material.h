...
class Material {
  ...
  public:
    ...
    static const std::array<std::array<int,64>,14> pieceSquareScoreArray;

    inline static const std::array<int,64> mg_pawn_table = {
      0,   0,   0,   0,   0,   0,  0,   0,
    ...
    inline static const std::array<int,64>  eg_pawn_table = {
          0,   0,   0,   0,   0,   0,   0,   0,
    ...
    inline static const std::array<int,64> mg_knight_table = {
    ...
    inline static const std::array<int,64> eg_knight_table = {
    ...
    inline static const std::array<int,64> mg_bishop_table = {
    ...
    inline static const std::array<int,64> eg_bishop_table = {
    ...
    inline static const std::array<int,64> mg_rook_table = {
    ...
    inline static const std::array<int,64> eg_rook_table = {
    ...
    inline static const std::array<int,64> mg_queen_table = {
    ...
    inline static const std::array<int,64> eg_queen_table = {
    ...
    inline static const std::array<int,64> mg_king_table = {
    ...
    inline static const std::array<int,64> eg_king_table = {
